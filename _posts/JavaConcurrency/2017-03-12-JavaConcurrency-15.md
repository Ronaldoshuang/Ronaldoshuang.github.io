...
![1.ConcurrentLinkedQueue初始化状态.png]({{ "/images/posts/JavaConcurrency/JavaConcurrency-15-1.png" | absolute_url }})
...
![2.offer 1后队列的状态.png]({{ "/images/posts/JavaConcurrency/JavaConcurrency-15-2.png" | absolute_url }})
...
![3.队列offer 2后的状态.png]({{ "/images/posts/JavaConcurrency/JavaConcurrency-15-3.png" | absolute_url }})


**tail指向的节点由Node0改变为Node2**,这里的casTail失败不需要重试的原因是，offer代码中主要是通过p的next节点q(`Node<E> q = p.next`)决定后面的逻辑走向的，当casTail失败时状态示意图如下：

![4.队列进行入队操作后casTail失败后的状态图.png]({{ "/images/posts/JavaConcurrency/JavaConcurrency-15-4.png" | absolute_url }})
...
![5.线程A和线程B有可能的执行时序.png]({{ "/images/posts/JavaConcurrency/JavaConcurrency-15-5.png" | absolute_url }})
...
![6.队列初始状态.png]({{ "/images/posts/JavaConcurrency/JavaConcurrency-15-6.png" | absolute_url }})
...
![](http://upload-images.jianshu.io/upload_images/2615789-c3c45ac89c461ab5.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
![7.队列出队操作后的状态.png]({{ "/images/posts/JavaConcurrency/JavaConcurrency-15-7.png" | absolute_url }})
...
![8.经过一次循环后的状态.png]({{ "/images/posts/JavaConcurrency/JavaConcurrency-15-8.png" | absolute_url }})
...
![9.Node2从队列中出队后的状态.png]({{ "/images/posts/JavaConcurrency/JavaConcurrency-15-9.png" | absolute_url }})
...
![10.offer和poll相互影响分析时队列初始状态.png]({{ "/images/posts/JavaConcurrency/JavaConcurrency-15-10.png" | absolute_url }})

因此在线程A执行offer时，线程B执行poll就会存在如下一种情况：

![11.线程A和线程B可能存在的执行时序.png]({{ "/images/posts/JavaConcurrency/JavaConcurrency-15-11.png" | absolute_url }})
...
![12.线程B进行poll后队列的状态图.png]({{ "/images/posts/JavaConcurrency/JavaConcurrency-15-12.png" | absolute_url }})
