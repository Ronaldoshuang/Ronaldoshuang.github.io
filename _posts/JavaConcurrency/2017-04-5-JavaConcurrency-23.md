...
![FutureTask状态迁移图.png]({{ "/images/posts/JavaConcurrency/JavaConcurrency-23-1.jpg" | absolute_url }})
...
![FutureTask的get和cancel的执行示意图.jpg]({{ "/images/posts/JavaConcurrency/JavaConcurrency-23-2.jpg" | absolute_url }})
