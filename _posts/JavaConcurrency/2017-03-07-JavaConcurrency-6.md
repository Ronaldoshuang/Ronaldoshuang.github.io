...
keywords: JavaConcurrency,final
---
# 1. final的简介 #
...
![final修饰成员变量]({{ "/images/posts/JavaConcurrency/JavaConcurrency-6-1.png" | absolute_url }})
...
![final修饰局部变量]({{ "/images/posts/JavaConcurrency/JavaConcurrency-6-2.png" | absolute_url }})
...
![final方法不能重写]({{ "/images/posts/JavaConcurrency/JavaConcurrency-6-3.png" | absolute_url }})
...
![final类不能继承]({{ "/images/posts/JavaConcurrency/JavaConcurrency-6-4.png" | absolute_url }})
# 3. final的例子 #
...
![final域写可能的存在的执行时序]({{ "/images/posts/JavaConcurrency/JavaConcurrency-6-5.png" | absolute_url }})
...
![final域读可能存在的执行时序]({{ "/images/posts/JavaConcurrency/JavaConcurrency-6-6.png" | absolute_url }})
...
![写final修饰引用类型数据可能的执行时序]({{ "/images/posts/JavaConcurrency/JavaConcurrency-6-7.png" | absolute_url }})
...
![final域引用可能的执行时序]({{ "/images/posts/JavaConcurrency/JavaConcurrency-6-8.png" | absolute_url }})
