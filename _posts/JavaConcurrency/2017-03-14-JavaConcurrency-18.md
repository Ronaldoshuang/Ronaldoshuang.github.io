---
layout: post
title: 从源码深入详解ThreadLocal内存泄漏问题
...
![threadLocal引用示意图.png]({{ "/images/posts/JavaConcurrency/JavaConcurrency-18-1.png" | absolute_url }})
...
![cleanSomeSlots示意图.png]({{ "/images/posts/JavaConcurrency/JavaConcurrency-18-2.png" | absolute_url }})
...
![cleanSomeSlots示意图.png]({{ "/images/posts/JavaConcurrency/JavaConcurrency-18-3.png" | absolute_url }})
...
![cleanSomeSlots执行情景图.png]({{ "/images/posts/JavaConcurrency/JavaConcurrency-18-4.png" | absolute_url }})
...
![向前环形搜索到脏entry，向后环形查找到可覆盖的entry的情况.png]({{ "/images/posts/JavaConcurrency/JavaConcurrency-18-5.png" | absolute_url }})
	...
	- 1.2后向环形查找未找到可覆盖的entry 
		...
		![前向环形搜索到脏entry,向后环形未搜索可覆盖entry.png]({{ "/images/posts/JavaConcurrency/JavaConcurrency-18-6.png" | absolute_url }})
...
- 2.前向没有脏entry
	...
	- 2.1后向环形查找找到可覆盖的entry 
		...
		![前向未搜索到脏entry，后向环形搜索到可覆盖的entry.png.png]({{ "/images/posts/JavaConcurrency/JavaConcurrency-18-7.png" | absolute_url }})
...
![前向环形未搜索到脏entry,后向环形查找未查找到可覆盖的entry.png]({{ "/images/posts/JavaConcurrency/JavaConcurrency-18-8.png" | absolute_url }})		
...
![1.2情况示意图.png]({{ "/images/posts/JavaConcurrency/JavaConcurrency-18-9.png" | absolute_url }})
